...
const selectFromAirport = (c) => {
    console.log(c)
    fromQuery.value = c.fullName
    showFromMenu.value = false
}
// Select for to
const selectToAirport = (c) => {
    console.log(c)
    toQuery.value = c.fullName
    showToMenu.value = false
}
// Switch two airports
const switchAirports = () => {
    let newFrom = toQuery.value
    let newTo = fromQuery.value

    fromQuery.value = newFrom
    toQuery.value = newTo
}
        ...
        <div class="bg-white rounded-[20px] p-[6px] mt-2 flex flex-col xl:flex-row">
            <div
                ...
                <div class="px-[12px] xl:px-[19px] py-[24px] xl:py-[30px] flex-1 border-b md:border-r border-[#D7E6FE] relative"
                    ...
                    <transition name="menu">
                        <div class="absolute top-[60px] left-0 z-[5] w-full shadow-md bg-white border rounded-b-md"
                            v-if="showFromMenu">
                            <ul class="" v-if="filteredFromData.length != 0">
                    ...
                    <button @click="switchAirports"
                        class="absolute bottom-[-35%] md:bottom-[10px] right-[50%] md:right-[-25px] z-[4] h-[48px] w-[48px] rounded-full bg-white flex items-center justify-center border border-of-gray rotate-90 md:rotate-0">
                ...
                <div class="px-[12px] md:pr-[19px] md:pl-[38px] py-[24px] xl:py-[30px] flex-1 border-b md:border-r border-[#D7E6FE] relative"
                    ...
                    <transition name="menu">
                        <div class="absolute top-[60px] left-0 z-[5] w-full bg-white border rounded-b-md shadow-md"
                            v-if="showToMenu">
                            <ul class="" v-if="filteredToData.length != 0">
                                <li class="px-2 py-2 cursor-pointer hover:bg-of-blue hover:text-white capitalize text-base font-medium border-b"
