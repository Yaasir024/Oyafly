    ...
    <section class="mt-[10px] ">
        ...
        <div class="bg-white rounded-[20px] p-[6px] mt-2 flex flex-col xl:flex-row">
            <div
                ...
                <div class="px-[12px] xl:px-[19px] py-[24px] xl:py-[30px] flex-1 border-b md:border-r border-[#D7E6FE]">
                    <div class="flex items-center">
                        ...
                        <span class="text-base xl:text-lg leading-[22px]">From?</span>
                    </div>
                </div>
                <div class="px-[12px] xl:px-[19px] py-[24px] xl:py-[30px] flex-1 border-b md:border-r border-[#D7E6FE]">
                    <div class="flex items-center">
                        ...
                        <span class="text-base xl:text-lg leading-[22px]">To?</span>
                    </div>
                </div>
                <div class="px-[12px] xl:px-[19px] py-[24px] xl:py-[30px] flex-1">
                    <div class="flex items-center">
                        ...
                        <span class="text-base xl:text-lg leading-[22px]">Going ⎯ Return Date</span>
                    </div>
                </div>
            </div>
