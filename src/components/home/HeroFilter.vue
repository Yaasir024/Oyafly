        ...
        <div
            ...
            <div class="h-[75px] md:h-[84px] flex items-center px-[12px] xl:px-[19px] border-b md:border-b-0 border-r-0 md:border-r border-[#D7E6FE] md:flex-33.33%  relative"
                ...
                <button @click="switchAirports"
                    class="absolute bottom-[-25px] md:bottom-[50%] md:translate-y-[50%] left-[50%] translate-x-[-50%] md:right-[-25px] z-[4] h-[48px] w-[48px] rounded-full bg-white flex items-center justify-center border border-of-gray rotate-90 md:rotate-0">
